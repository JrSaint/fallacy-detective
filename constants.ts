...
export const FALLACIES: Fallacy[] = [
  ...
  { name: "Burden of Proof", emoji: "⚖️" },
  { name: "Ambiguity", emoji: "🔀" },
  { name: "The Gambler", emoji: "🎲" },
  { name: "The Bandwagon", emoji: "🚌" },
  { name: "Appeal to Authority", emoji: "👑" },
  { name: "Composition & Division", emoji: "🧩" },
  { name: "No True Scotsman", emoji: "🏴" },
  { name: "Origins", emoji: "🌱" },
